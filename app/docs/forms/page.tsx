...
export default function FormsSection() {
    ...
    const { file, previewUrl, fileName, handleFileChange, handleRemove, fileInputRef, handleThumbnailClick } = useFileUpload({
        onUpload: async (file) => {
            if (!file) {
    ...
    return (
        <section className="min-h-[80vh] flex flex-col items-center justify-center space-y-12 py-20">
            <div className="text-center space-y-2">
                ...
                <Typography.Muted>Input controls and data entry patterns for the ProExam interface.</Typography.Muted>
            </div>
                ...
                <div className="grid md:grid-cols-2 gap-16">
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4 pt-4 border-t border-slate-50">
                            <Typography.Muted className="text-xs font-bold uppercase tracking-wider">Specialized Cards</Typography.Muted>
                    ...
                    <div className="space-y-6">
                        ...
                        <RadioGroup defaultValue="comfortable" className="space-y-3">
                            ...
                            <div className="flex items-center space-x-3 p-3 rounded-xl border border-transparent hover:border-slate-100 hover:bg-slate-50/50 transition-colors">
                                ...
                                <Label htmlFor="r2" className="cursor-pointer">Comfortable Padding</Label>
                            </div>
                        </RadioGroup>
                    </div>
                </div>
                    ...
                    <div className=" mx-auto space-y-4">
                        ...
                        {uploadStatus === 'success' && uploadedUrl && (
                            <div className="flex items-center justify-between p-3 rounded-lg bg-emerald-50 border border-emerald-100 text-emerald-700 animate-in fade-in slide-in-from-bottom-2">
                                ...
                                >
                                    <a href={uploadedUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1">
