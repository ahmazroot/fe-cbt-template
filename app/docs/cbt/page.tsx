  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center space-y-12 py-20 px-4 bg-slate-50">
      <div className="text-center space-y-2">
        ...
        <Typography.Muted>
          Specialized components for Computer Based Test interfaces.
        </Typography.Muted>
      </div>
        ...
        <div className="p-8 rounded-3xl bg-slate-900 shadow-2xl space-y-10 border border-slate-800 overflow-hidden relative">
          ...
          <div className="relative space-y-2">
            ...
            <p className="text-slate-400 max-w-2xl">
              High-fidelity components designed for focus, clarity, and reliability during digital
              assessments.
            </p>
          </div>
            ...
            <div className="lg:col-span-2 space-y-8 bg-white p-8 md:p-12 rounded-2xl shadow-2xl border border-slate-100">
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <span className="bg-primary-900 text-white text-sm font-bold h-10 w-10 shrink-0 rounded-xl flex items-center justify-center shadow-lg shadow-primary-900/20">
                    12
                  </span>
                  <div className="space-y-4">
                    ...
                    <p className="text-slate-500 leading-relaxed">
                      Pilihlah salah satu jawaban yang paling tepat berdasarkan pengetahuan teknis
                      mengenai optimasi jaringan dan protokol web modern.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-8 border-t border-slate-100 mt-8">
                ...
                <div className="flex gap-3 w-full sm:w-auto">
                  <Button
                    variant="secondary"
                    className="flex-1 sm:flex-none bg-amber-50 text-amber-700 hover:bg-amber-100 border-amber-200"
                  >
                    Ragu-ragu
                  </Button>
                  <Button className="flex-1 sm:flex-none px-8">Simpan & Lanjutkan</Button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="p-8 rounded-2xl border border-slate-100 bg-white shadow-sm space-y-4 text-center">
            ...
            <p className="text-sm text-slate-500">
              Auto-formatting timer with color shifts when time is running low.
            </p>
          </div>
          ...
          <div className="p-8 rounded-2xl border border-slate-100 bg-white shadow-sm space-y-4 text-center">
            ...
            <p className="text-sm text-slate-500">
              Reusable options with various states (Selected, Hover, Correct/Incorrect).
            </p>
          </div>
        </div>
      </div>
