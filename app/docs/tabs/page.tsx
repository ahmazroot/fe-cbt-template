    ...
    return (
        <section className="min-h-screen flex flex-col items-center justify-center space-y-12 py-20 px-4 bg-slate-50">
            <div className="text-center space-y-2">
                ...
                <Typography.Muted>Flexible navigation patterns for switching between related views.</Typography.Muted>
            </div>
            ...
            <div className="w-full max-w-4xl space-y-16">
                ...
                <div className="space-y-6">
                    <div className="text-center space-y-1">
                        ...
                        <Typography.Muted className="text-xs italic">Lightweight, inline navigation</Typography.Muted>
                    </div>
                ...
                <div className="space-y-8">
                    <div className="text-center space-y-1">
                        ...
                        <Typography.Muted className="text-xs italic">High-fidelity container for major navigation modules</Typography.Muted>
                    </div>
                        ...
                        <div className="mt-6 p-12 bg-slate-50 rounded-xl border border-dashed border-slate-200 text-center space-y-4 transition-all">
                            {activeTab === 'account' && (
                                <div className="space-y-2 animate-in fade-in slide-in-from-bottom-2 duration-300">
                                    ...
                                    <Typography.Muted>Update your personal information and profile settings.</Typography.Muted>
                                </div>
                            )}
                            {activeTab === 'security' && (
                                <div className="space-y-2 animate-in fade-in slide-in-from-bottom-2 duration-300">
                                    ...
                                    <Typography.Muted>Manage passwords and two-factor authentication.</Typography.Muted>
                                </div>
                            )}
                            {activeTab === 'notifications' && (
                                <div className="space-y-2 animate-in fade-in slide-in-from-bottom-2 duration-300">
                                    ...
                                    <Typography.Muted>Configure how you want to be notified about updates.</Typography.Muted>
                                </div>
                            )}
                        </div>
                    </ExamTabs>
