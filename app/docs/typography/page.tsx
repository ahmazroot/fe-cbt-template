  ...
  return (
    <section className="min-h-[80vh] flex flex-col items-center justify-center space-y-12 py-20">
      <div className="text-center space-y-2">
        ...
        <Typography.Muted>
          Standard text styles and hierarchies for the ProExam interface.
        </Typography.Muted>
      </div>
      ...
      <div className="w-full max-w-4xl rounded-3xl border border-slate-100 bg-white p-12 md:p-16 shadow-xl shadow-slate-200/50 space-y-12">
        ...
        <div className="group space-y-2">
          <Typography.P>
            Body text standard. Digunakan untuk paragraf umum. Memberikan kenyamanan baca yang
            optimal dengan line-height yang cukup.
          </Typography.P>
          <div className="flex items-center gap-2">
        ...
        <div className="group space-y-2">
          <Typography.Muted>
            Small / Muted text. Digunakan untuk caption, hint, atau footer card yang memberikan
            informasi tambahan tanpa mendominasi visual.
          </Typography.Muted>
          <div className="flex items-center gap-2">
