      ...
      <div className="max-w-5xl mx-auto space-y-16">
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-xl border border-slate-100 bg-white p-8 space-y-6">
            <div>
              ...
              <Typography.Mono className="mt-1">
            ...
            <div>
              <Typography.P>
                Body text standard. Digunakan untuk paragraf umum. Lorem ipsum dolor sit amet,
        ...
        <section className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            />
            <StatsCard title="Siswa Aktif" value="1,240" icon={<InfoIcon className="size-6" />} />
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <StandardCard title="Analisis Mingguan" description="Data statistik performa siswa.">
              <div className="h-24 bg-slate-50 rounded border border-dashed border-slate-200 flex items-center justify-center text-slate-400 text-sm">
                Content Area
              </div>
            </StandardCard>
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-slate-800">
              Navigation Tabs (Enhanced Component)
            </h3>
            <ExamTabs
              withContainer
              value={activeExamTab}
            ...
            >
              <div className="p-10 bg-slate-50 mt-4 rounded-xl text-sm text-slate-500 text-center">
                ...
                {activeExamTab === 'account'
                  ? 'Detail Akun'
                  : activeExamTab === 'history'
                    ? 'Riwayat Transaksi'
                    : 'Pengaturan'}
                )
              </div>
            ...
            <div className="lg:col-span-2 space-y-6 bg-white p-8 rounded-2xl shadow-xl">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <span className="bg-primary-900 text-white text-sm font-bold h-8 w-8 rounded-lg flex items-center justify-center">
                    12
                  </span>
        ...
        <section className="text-center py-10">
          <Dialog>
            <DialogTrigger asChild>
              <Button
                size="lg"
                className="h-14 px-10 text-lg rounded-2xl shadow-xl shadow-primary-900/30"
              >
