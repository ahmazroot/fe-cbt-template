...
import { PackageIcon, UsersIcon, TrendingUpIcon, ArrowRightIcon, MoreVerticalIcon } from 'lucide-react';
            ...
            <div className="w-full max-w-5xl space-y-12">
                        ...
                        >
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <Button variant="ghost" size="sm" className="text-xs">View Details <ArrowRightIcon className="ml-2 size-3" /></Button>
                                </div>
                            </div>
                        </StandardCard>
                    </div>
                        ...
                        <Card className="shadow-lg shadow-slate-200/50 border-slate-100">
                            <CardHeader className="flex flex-row items-start justify-between space-y-0">
                                <div className="space-y-1.5">
                                    <Badge variant="outline" className="mb-1">Announcement</Badge>
                            ...
                            <CardContent>
                                <p className="text-sm text-slate-600 leading-relaxed">
                                    The system will be offline for approximately 2 hours to perform database migrations and performance optimizations.
                                </p>
                            </CardContent>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {[1, 2, 3, 4].map((i) => (
                            <div key={i} className="p-6 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md hover:border-primary-100 transition-all cursor-pointer group">
                                ...
                                <h4 className="font-bold text-slate-900 mb-1 group-hover:text-primary-900 transition-colors text-sm">Category {i}</h4>
