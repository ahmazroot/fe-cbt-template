  ...
  (
    ...
    return (
      <div className={cn('w-full relative', className)}>
        <Input type="file" className="hidden" ref={fileInputRef} {...props} />
          ...
          <div className="relative">
            <div className="group relative h-32 overflow-hidden rounded-lg border bg-muted/20">
              ...
              <div className="absolute inset-0 flex items-center justify-center gap-2 opacity-0 transition-opacity group-hover:opacity-100">
                ...
                <Button size="sm" variant="destructive" onClick={onRemove} className="h-9 w-9 p-0">
        ...
        {isLoading && (
          <div className="absolute inset-0 z-50 flex items-center justify-center rounded-lg bg-background/60 backdrop-blur-[1px]">
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-xs font-medium text-muted-foreground text-slate-500">
                Mengunggah...
              </p>
            </div>
          </div>
